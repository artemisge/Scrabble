...
Η SakClass περιλαμβάνει:
    - Μια δομή λεξικού "letters" (dictionary) για να κρατάει το πλήθος των γραμμάτων και την αξία τους.
...
Η Player περιλαμβάνει:
    ...
    - Την συνάρτηση repr που τυπώνει το όνομα της κλάσης και τα διαθέσιμα γράμματα.
...
Η Game περιλαμβάνει:
    ...
    - Την συνάρτηση repr που τυπώνει το όνομα της κλάσης και την τρέχον ρύθμιση.
